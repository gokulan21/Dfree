...
class _ClientReportsPageState extends State<ClientReportsPage> {
  ...
  int get _pendingProjects => (_metrics['pendingProjects'] as num?)?.toInt() ?? 0;
  double get _totalBudget => (_metrics['totalBudget'] as num?)?.toDouble() ?? 0.0;
  double get _totalPaid => (_metrics['totalPaid'] as num?)?.toDouble() ?? 0.0;
